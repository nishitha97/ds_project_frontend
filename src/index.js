...
import CreateNewTicket from "./component/CreateNewTicket";
        ...
        <Router>
            ...
            <div>
                <nav className={"navbar navbar-inverse"}>
                    <p style={{fontSize: 20, color: "white"}}><Link to="/login">Login </Link>|<Link to="/signUp"> Sign
                        up</Link></p>
                ...
                <div className={"container-fluid text-center"}>
                    <div className={"row content"}>
                        <div className={"col-sm-2 sidenav"} style={{height: "auto"}}>
                            ...
                            <div className={"well"}><p style={{fontSize: 15}}><Link to="/users">View All Users </Link>
                            </p></div>
                            <div className={"well"}><p style={{fontSize: 15}}><Link to="/payments">View All
                                Payments </Link></p></div>
                        </div>
                        <div className={"col-sm-8 text-left"} style={{textAlignLast: "center"}}>
                            ...
                            <Route path="/booking/payment/ticket" component={CreateNewTicket}/>
